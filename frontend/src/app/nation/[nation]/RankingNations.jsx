                        ...
                        {nationsRankings.map((nation, index) => {
                            return (
                                <div key={index} className={props.currentNation == nation.nation ? "table-row highlighted-nation" : "table-row"}>
                                    ...
                                    <p><Link href={"/nation/" + nation.nation.toLowerCase().replace("ø", "oe").replace("æ", "ae").replace("å", "aa")}><span className={"fi fi-" + nation.nationFlagCode}></span>{nation.nation}</Link></p>
