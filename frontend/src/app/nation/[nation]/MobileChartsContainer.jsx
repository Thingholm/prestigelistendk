        ...
        <div className="mobile-charts-container">
            <div className="mobile-charts-header-and-options-container">
                ...
                <div className="btn-container">
                    ...
                    <button onClick={() => setGraphShowStatus(3)} className={graphShowStatus == 3 && "btn-active"}>Antal resultater</button>
            ...
            <NationAccChart rankingData={props.accData} active={graphShowStatus} countData={props.countData} />
        </div>
    )
}