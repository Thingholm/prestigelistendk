                    ...
                    {filteredRanking.map((nation, index) => {
                        ...
                        return (
                            <div key={index} className="table-row">
                                ...
                                <p>{greatestRiders.map((i, index) => { if (index == 2) { return (<Link key={i.fullName} href={"rytter/" + stringEncoder(i.fullName)}>{i.fullName}</Link>) } else { return (<Link key={i.fullName} href={"rytter/" + stringEncoder(i.fullName)}>{i.fullName + ", "}</Link>) } })}</p>
